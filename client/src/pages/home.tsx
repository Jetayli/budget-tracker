            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Category Name</FormLabel>
                  <FormControl>
                    <Input data-testid="input-edit-category-name" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-sm">SAR</span>
                      <Input type="number" step="1" min="0" className="pl-12 tabular-nums" data-testid="input-edit-category-budget" {...field} />
                    </div>
                  </FormControl>
                  <FormMessage />
                </FormItem>
